...
(function() {
  var ImageCell, Item, ItemCollection, MoreLinkCell, columns, ready,
  ...
  MoreLinkCell = (function(superClass) {
    extend(MoreLinkCell, superClass);

    function MoreLinkCell() {
      return MoreLinkCell.__super__.constructor.apply(this, arguments);
    }

    MoreLinkCell.prototype.getUri = function(id) {
      return '/items/' + id;
    };

    MoreLinkCell.prototype.render = function() {
      var uri;
      this.$el.empty();
  ...
  ImageCell = (function(superClass) {
    extend(ImageCell, superClass);

    function ImageCell() {
      return ImageCell.__super__.constructor.apply(this, arguments);
    }

    ImageCell.prototype.render = function() {
      var uri;
      this.$el.empty();
  ...
  ready = function() {
    var collection, grid, gridContainer;
    ...
    if (gridContainer.length > 0) {
      ...
      return grid.$el.addClass('table-striped');
    }
  };
